...
public class BoardVO {
	...
	//*************************************************
	MultipartFile file; //***** 이 변수명이 <input name="" 과 동일
	...
	public void setFile(MultipartFile file) {
		...
		if(!file.isEmpty()) { //OriginalFilename() 오리지널 본연의 이름 갖고옴
			b_fname = file.getOriginalFilename();
			b_fsize = file.getSize();
			//파일 직접경로 잡아주기 (이 경로로 저장됨)
			File f = new File("D:\\Git\\Spring\\hWebBoard\\src\\main\\webapp\\resources\\upload\\"+b_fname);
